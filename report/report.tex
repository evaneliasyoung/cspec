...
\emph{JSON for Modern C++} was chosen as a single-header option, written for C++17 it includes very modern features and encourages the use of these quite well.
...
\emph{argparse} was chosen as a single-header option, written for C++17 it includes very modern features and encourages the use of these quite well.
...
I would like to thank Niels Lohmann et. al. for their contributions to \emph{JSON for Modern C++},
and Pranav et. al. for their contributions to \emph{argparse}.
